Prajakti Kapade - Have written the code for ResNet+Swin notebook (everything except data loader and image processing) and SAM implementation in ResNet+Swin+PSP+SAM implementation also including the training and testing code for each notebook.
Sahasra Iyer - Have written the code for ResNet notebook (everything except data loader and image processing) and PSP implementation in ResNet+Swin+PSP+SAM implementation, along with code for three losses and errors. 
